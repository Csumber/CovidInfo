...
export const ARTICLES: response =
  {
    URL_that_is_not_included: 'https://newsapi.org/v2/top-headlines?country=hu&category=health&apiKey=80cb891de89c47be9dd31896db6c7f2e',
    status: 'ok',
    totalResults: 5,
    articles: [
      {
      ...
      },
      {
        ...
        title: 'NyugatiJelen.com - A rákot is el fogják pusztítani? - Nyugati Jelen',
        description: 'A rákot is el fogják pusztítani – ígéri a koronavírus elleni vakcina feltalálója.',
      ...
      },
      {
        ...
        author: null,
        title: 'Megjelentek a tudnivalók az orosz vakcináról | Weborvos.hu - Weborvos',
        description: 'K&ouml;r&uuml;ltekint&eacute;ssel alkalmazhat&oacute; az orosz vakcina, ha az &eacute;rintett&nbsp;kr&oacute;nikus vesebeteg vagy m&aacute;jbeteg, epilepszi&aacute;s.&nbsp;',
        url: 'https://weborvos.hu/gyogyszerpiac/megjelentek-a-tudnivalok-az-orosz-vakcinarol-266068',
        urlToImage: 'https://weborvos.hu/data/articles/266/2660/article-266068/korona_vakcina_Szputnyik.jpg',
        publishedAt: new Date(Date.parse('2021-03-21T07:48:03Z')),
        content: 'Felkerült az Országos Gyógyszerészeti és Élelmezés-egészségügyi Intézet (OGYÉI) honlapjára a betegtájékoztató Sputnik V vakcinával oltottak számára. Ebben tájékoztatnak az esetleges mellékhatásokról,… [+1769 chars]'
      },
      {
        source: {
          id: null,
        ...
        description: 'Az eleinte csak nagyobb terhel&eacute;sre &ndash; p&eacute;ld&aacute;ul l&eacute;pcsőz&eacute;sn&eacute;l - jelentkező neh&eacute;zl&eacute;gz&eacute;s a folyamatok előrehalad&aacute;s&aacute;val s&uacute;lyosbodik.',
        url: 'https://weborvos.hu/egeszsegmagazin/copd-ez-zajlik-a-tudoben-266065',
        urlToImage: 'https://weborvos.hu/data/articles/266/2660/article-266065/tudo3.jpg',
        publishedAt: new Date(Date.parse('2021-03-20T12:34:40Z')),
        content: 'Milyen visszafordíthatatlan folyamat játszódik le a tüdben, amitl a betegek számára egyre nehezebbé válik a légzés? Errl kérdeztük dr. Hidvégi Edit tüdgyógyászt, a Tüdközpont orvosát.\r\nElssorban dohá… [+2273 chars]'
      },
      {
        source: {
          id: null,
